...
class PartidosControllerTest < ActionController::TestCase
  ...
  test "should create partido" do
    assert_difference('Partido.count') do
      post :create, partido: { cancha_id: @partido.cancha_id, fecha: @partido.fecha, fecha_encuentro: @partido.fecha_encuentro }
    end
  ...
  test "should update partido" do
    put :update, id: @partido, partido: { cancha_id: @partido.cancha_id, fecha: @partido.fecha, fecha_encuentro: @partido.fecha_encuentro }
    assert_redirected_to partido_path(assigns(:partido))
  end
